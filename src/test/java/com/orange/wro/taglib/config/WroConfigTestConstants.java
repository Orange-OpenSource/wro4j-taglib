 ...
 * Date: 22/12/12
 */
public interface WroConfigTestConstants {
    String PROPERTIES_TEST_FILENAME = "wro4j-taglib-test.properties";

    String DEFAULT_BASE_URL = "defaultBaseUrl";
    String DEFAULT_LESS_PATH = "defaultLessPath";
